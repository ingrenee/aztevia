...
<?php if ( is_search() or is_tag() ) : // Only display Excerpts for Search ?>
				...
				<div class="search-item">
						...
						<div class="custom-image-content">
								<div class="custom-image">
										<?php the_post_thumbnail('custom-image-search'); ?>
								</div>
						...
						<?PHP endif;?>
						<h1  class="entry-title" > <a href="<?php the_permalink(); ?>" class="color-font-1" rel="bookmark">
								<?php the_title(); ?>
								</a> </h1>
						<?php the_excerpt(); ?>
				</div>
		...
		<div class="row">
				<div class="large-12 columns">
						<div class="entry-content">
								...
								<?PHP endif;?>
								<?php if ( is_single() ) : ?>
								<h1 class="entry-title color-font-1">
										<?php the_title(); ?>
								</h1>
								<?php else : ?>
